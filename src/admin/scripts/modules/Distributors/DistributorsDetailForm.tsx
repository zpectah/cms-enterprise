...
interface DistributorsDetailFormProps {
	allItems: DistributorsItemProps[];
	detailData: DistributorsItemProps;
	onSubmit: (data: DistributorsItemProps, e: any) => void;
...
const DistributorsDetailForm = ({
	...
	const submitHandler = (data: DistributorsItemProps, e: any) =>
		onSubmit(data, e);
	...
	const getTypeOptions = useCallback(
		() => getOptionsList(config.options.model.Distributors.type, t),
		[detailData],
	);
